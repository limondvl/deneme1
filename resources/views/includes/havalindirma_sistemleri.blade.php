        ...
        <div class="container py-15 py-md-17">
            <div class="row text-center mb-10">
                <div class="col-md-10 col-lg-9 col-xxl-8 mx-auto">
                    <h2 class="fs-16 text-uppercase text-muted mb-3">&#160; </h2>              <h2 class="fs-16 text-uppercase text-muted mb-3"> </h2>
                    <h2 class="fs-16 text-uppercase text-muted mb-3"> &#160;</h2>
                    <h2 class="fs-16 text-uppercase text-muted mb-3"> &#160;</h2>

                    <h1 class="display-3 px-xl-10 mb-0"></h1>
                </div>
                <!-- /column -->
            </div>
            <!-- /.row -->
            <div class="row gx-lg-0 gy-10 mb-15 mb-md-17 align-items-center">
                <div class="col-lg-6">
                    <figure class="rounded mb-0"><img class="img-fluid" src="{{asset('uploads/front_images')}}/havalandirma-sistemleri.jpg" alt="Havalandırma sistemləri"></figure>
                </div>
                <!--/column -->
                <div class="col-lg-5 ms-auto">
                    <h3 class="fs-28 mb-3">Havalandırma sistemləri</h3>
                    <p>Havalandırma necə aparılmalıdır? Ümumi yerlərdə və qapalı yerlərdə havalandırma yoxdursa, bu ərazilərdə yaşamaq qeyri-mümkün olur. Bu vəziyyətlər üçün peşəkar havalandırma sistemlərindən istifadə olunur. Bir mühitdə tələb olunan hava miqdarı məkanın həcminə, istifadə üsuluna və daim orada olan insanların sayına görə dəyişir. Bu səbəbdən hər bir imkan nəzərə alınaraq havalandırma üçün ən ideal layihə hazırlanır. Havalandırma tələbinə uyğun olaraq təyin ediləcək ventilyasiya variantları həmişə ən yaxşısı nəzərə alınmaqla hazırlanır. Çünki idman zalı ilə restoranın havalandırma ehtiyacları eyni olmayacaq. Mətbəxin və məkandakı tualetlərin havalandırılması da müxtəlif sistemlərdən istifadə edilməklə həyata keçiriləcək. Bu səbəbdən havalandırma sisteminin qurulacağı yer ilk növbədə kəşf edilir və vəziyyətin təhlilindən sonra müvafiq ventilyasiya sistemi quraşdırılır.</p>
                    <ul class="icon-list bullet-bg bullet-soft-primary">
                        <li><span><i class="uil uil-check"></i></span><span>Münasib qiymət</span></li>
                        <li><span><i class="uil uil-check"></i></span><span>Xidmətlərə zəmanət</span></li>
                        <li><span><i class="uil uil-check"></i></span><span>12 illik peşəkar təcrübə</span></li>
                        <li><span><i class="uil uil-check"></i></span><span>Təcili usta xidməti</span></li>
                        <li><span><i class="uil uil-check"></i></span><span>Müştəri məmnuniyyəti</span></li>
                    </ul>
                    <a href="#" class="btn btn-soft-primary rounded-pill mt-2 mb-0">Zəng edin</a>
                </div>
                <!--/column -->
            </div>
            <!--/.row -->
            <div class="row gx-lg-0 gy-10 mb-15 mb-md-17 align-items-center">
                <div class="col-lg-6 order-lg-2 ms-auto">
                    <figure class="rounded mb-0"><img class="img-fluid" src="./assets/img/illustrations/ui1.png" srcset="./assets/img/illustrations/ui1@2x.png 2x" alt=""></figure>
                </div>
            ...
            <div class="row gx-lg-0 gy-10 align-items-center">
                <div class="col-lg-6">
                    <figure class="rounded mb-0"><img class="img-fluid" src="./assets/img/illustrations/ui5.png" srcset="./assets/img/illustrations/ui5@2x.png 2x" alt=""></figure>
                </div>
