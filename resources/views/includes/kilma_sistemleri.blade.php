    ...
    <section class="wrapper bg-light">
        <div class="container py-15 py-md-17">
            ...
            <div class="row gx-lg-0 gy-10 mb-15 mb-md-17 align-items-center">
                <div class="col-lg-6">
                    <figure class="rounded mb-0"><img class="img-fluid" src="{{asset('uploads/front_images')}}/kondisioner-sistemleri.jpg" alt="Kondisioner sistemləri"></figure>
                </div>
                <!--/column -->
                <div class="col-lg-5 ms-auto">
                    <h3 class="fs-28 mb-3">Kondisioner sistemləri</h3>
                    <p>"Split sistem günümüzdə ən təlabatlı kondisioner sistemidir. Çox zaman öz məkanlarında bu sistemi quraşdıran insanlar üçün də ortaya maraqlı bir sual çıxa bilir. Bəs Split sistemli kondisioner nədir?!
                        Split sistemli kondisioner xarici və daxili 2 blokdan ibarət bir sistemdir. Adını ingilis dilindən tərcümədə ayırmaq sözü olan Split sözündən götürülmüşdür. Bu sistemdə kondisionerin funksionallığı bu iki blok arasında bölünmüşdür.

                        Split sistem havanın soyudulması üzrə ən universal sistem hesab edilir. Onu təkcə evlərdə deyil eyni zamanda ofislərdə, ticarət mərkəzlərində və digər tipli binalarda quraşdırılır.

                        Biz sizə bu tipli sistemlərin təmirində ən funksional xidmət təklif edirik. Əgər sizin də kondisionerinizin təmirə ehtiyacı varsa, buyurun, bizə müraciət edin"</p>
